  ...
  `)).toMatchSnapshot();
    ...
    describe('for interpolation', () => {
        it('add support for interpolation syntax', () => {
            expect(parse(`Interpolation can stand alone like the following
...
`)).toMatchSnapshot();
        ...
        it('add support for bang! interpolation syntax', () => {
            expect(parse(`Bang! Interpolation can stand alone like the following
